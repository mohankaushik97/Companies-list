...
class ApplicationVer2(QMainWindow):
    ...
    def initializations(self):
        ...
        self.new_entry_obj = ObjImports()
        self.update_obj = ObjImports()
    ...
    def newEntry(self):
        ...
        self.entry_comp_box = self.new_entry_obj.disp_comp_group_box()
        
        self.comp_role_vlayout.addWidget(self.entry_comp_box)
    ...
    def dispUpdateComp(self):
        ...
        self.update_comp_box = self.update_obj.disp_comp_group_box()
        self.update_comp_layout.addWidget(self.update_comp_box)
